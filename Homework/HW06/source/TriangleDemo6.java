...
public class TriangleDemo6 extends Application 
{
	Pane drawingBoard;
	HBox hb_T;
	HBox hb_B;
    ...
    public void start(Stage myStage) 
	{
		...
		Text descriptionText = new Text("  This program takes in the values for the x and y coordinates and the height\n"
										...
										+ "  - Interior Disjoint (Seperated)\n"
										+ "  - Proper Overlap (Touching)\n"
										+ "  - Equal (The exact same)\n"
										+ "  - PP (Triangle 1 is inside Triangle 2)\n"
										+ "  - PPc (Triangle 2 is inside Triangle 1)\n");
